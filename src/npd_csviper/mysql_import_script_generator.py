#!/usr/bin/env python3
"""
MySQL Import Script Generator for npd_CSViper
...
"""
MySQL CSV Import Script - Generated by npd_CSViper 
...
def main(env_file_location, csv_file, db_schema_name, table_name, trample):
    ...
    This script was generated by npd_CSViper for the CSV file: {metadata['filename']}
    """
    try:
