...
Generated on: 2025-06-29 00:46:58
"""
    ...
    try:
        ...
        try:
            db_config, db_schema_name, table_name, metadata, encoding = ImportExecutor.load_and_validate_config(
                env_file_location, csv_file, db_schema_name, table_name, 'test_data.metadata.json', use_colors=False
            )
        ...
        ImportExecutor.execute_mysql_import(
            ...
            'test_data.create_table_mysql.sql', 'test_data.import_data_mysql.sql'
        )
